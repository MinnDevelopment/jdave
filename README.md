...
dependencies {
    ...
    implementation("club.minnced:jdave-api:0.1.4")

    // Compiled natives for libdave for the specified platform
    implementation("club.minnced:jdave-native-linux-x86-64:0.1.4")
    implementation("club.minnced:jdave-native-linux-aarch64:0.1.4")
    implementation("club.minnced:jdave-native-win-x86-64:0.1.4")
    implementation("club.minnced:jdave-native-darwin:0.1.4")
}
```
